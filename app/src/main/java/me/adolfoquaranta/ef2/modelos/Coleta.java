...
public class Coleta {
    private Long id_Coleta, idForm_Coleta;
    private String nome_Coleta, descricao_Coleta, dataCriacao_Coleta,   dataUltimaEdicao_Coleta, status_Coleta, tipo_Coleta, modeloForm_Coleta;


    public Coleta(Long id_Coleta, Long idForm_Coleta, String nome_Coleta, String descricao_Coleta, String dataCriacao_Coleta, String dataUltimaEdicao_Coleta, String status_Coleta, String tipo_Coleta, String modeloForm_Coleta) {
        ...
        this.modeloForm_Coleta = modeloForm_Coleta;
    }
    ...
    public void setModeloForm_Coleta(String modeloForm_Coleta) {
        this.modeloForm_Coleta = modeloForm_Coleta;
    }
    ...
    public String getModeloForm_Coleta() {
        return modeloForm_Coleta;
    }
    ...
    public String toString() {
        return "Coleta{" +
                ...
                ", modeloForm_Coleta='" + modeloForm_Coleta + '\'' +
                '}';
    }
}
